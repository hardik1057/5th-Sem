/*WAP in C to find the ime taken by insertion sort to sort unsorted array, sorted array, reverse sorted array. Take note of time taken by the algoritm and plot a graph*/
#include <stdbool.h>
#include <time.h>
#include <stdlib.h>
#include <stdio.h>
